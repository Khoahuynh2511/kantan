...
export default async function Credits() {
  ...
  Thank you to everyone who has contributed to **KanTan** — maintainers, contributors, translators, and supporters.

  KanTan is what you see today thanks to everyone's work and suggestions. We'll keep making it **better**, and we hope you stay with us on this amazing adventure!
  `;
          ...
          <div className="mt-8 p-6 bg-[var(--card-color)] border border-[var(--border-color)] rounded-lg">
            ...
            <p className="text-[var(--secondary-color)] text-sm">
              ...
              <a
                ...
                href="https://github.com/lingdojo/kantan"
                target="_blank"
                rel="noreferrer"
              >
                GitHub repository
          ...
          <div className="mt-8 p-6 bg-[var(--card-color)] border border-[var(--border-color)] rounded-lg">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a
                ...
                href="https://www.patreon.com/cw/kantan"
                target="_blank"
                rel="noreferrer"
              >
                Patreon
