...
export default function translationGen(t: (key: string) => string) {
  const info = {
    '/': {
      ...
      content: (
        <>
          ...
          community, and help KanTan continue growing? Then please consider
          donating{' '}
          <Link
    ...
    '/kana': {
      header: <span>Welcome to Kana (Hiragana and Katakana)!</span>,
      content: (
        <>
          <p className="text-lg text-[var(--secondary-color)]">
    ...
    '/kanji': {
      header: <span>Welcome to Kanji!</span>,
      content: (
        <>
          <p className="text-lg text-[var(--secondary-color)]">
    ...
    '/vocabulary': {
      header: <span>Welcome to Vocabulary!</span>,
      content: (
        <>
          <p className="text-lg text-[var(--secondary-color)]">
