...
At **KanTan**, we take security seriously and strive to protect our website and users from potential threats. Although our website does not collect personal user data directly, we implement security measures to safeguard our platform.


## 1. Scope

This Security Policy applies to the **KanTan** website (kantan.com), including its infrastructure, content, and third-party services used (such as Google Analytics, Microsoft Clarity, and PostHog).
...
- 📩 **Bug Report Form:** kantan.com/report 
...
**Thank you for helping KanTan maintain a safe and secure website! 🚀**  
`;
